---
title: "How Gratuity is Calculated in India (Formula + Examples)"
metaTitle: "How Gratuity is Calculated — Formula & Examples | Esytol"
metaDescription: "Understand the gratuity formula for covered and non-covered employees, the 26 vs 30 divisor, the 6-month rounding rule, the ₹20 lakh cap, and worked examples."
slug: "how-gratuity-is-calculated"
category: "retirement"
tags: ["gratuity calculation", "gratuity formula", "payment of gratuity act", "gratuity"]
...
If you would rather see the result than run the maths, the [Gratuity Calculator](/tools/gratuity-calculator) applies every rule below automatically and shows a step-by-step breakdown.
...
The same person with the same tenure and salary receives **₹90,000 less** simply because the employer is not covered — the combined effect of the larger divisor and the dropped part-year. Toggle the coverage switch in the [Gratuity Calculator](/tools/gratuity-calculator) to see this difference for your own numbers.
...
Beyond a certain point, extra years or salary no longer increase your gratuity because of the cap. The "Gratuity by Years of Service" chart in the [Gratuity Calculator](/tools/gratuity-calculator) shows exactly where your curve flattens at ₹20 lakh.
...
- Your provident fund corpus — project it with the [EPF Calculator](/tools/epf-calculator).
...
For covered employees: (15 × last drawn salary × years of service) ÷ 26. For non-covered employees, the divisor is 30 and only completed years count.

**Why is the divisor 26 for covered employees?**
Because the Act treats a month as 26 working days (excluding four weekly offs), which makes 15 days' wages a larger fraction of monthly pay than the 30-day basis.

**Does salary mean my full CTC?**
No. It means your last drawn Basic Salary plus Dearness Allowance only.

**How are extra months counted?**
For covered employees, more than 6 months rounds up to a full year. For non-covered employees, extra months are ignored.

**Is there a maximum gratuity?**
Yes, ₹20 lakh under the Act. The calculator applies this cap automatically.

**How do I calculate mine quickly?**
Enter your salary, years, months, and coverage into the [Gratuity Calculator](/tools/gratuity-calculator) for an instant, step-by-step result.
