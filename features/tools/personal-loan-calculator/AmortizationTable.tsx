...
import type { AmortizationRow } from "@/lib/personalLoan";
import { scheduleToCSV, downloadCSV, formatINR } from "@/lib/personalLoan";
...
export function AmortizationTable({ rows, loanAmount }: AmortizationTableProps) {
  ...
  const handleDownload = useCallback(() => {
    ...
    downloadCSV(csv, "personal-loan-amortization-schedule.csv");
  }, [rows, loanAmount]);
  ...
  return (
    <section aria-labelledby="personal-loan-amortization-heading">
      <div className="mb-4 flex items-center justify-between gap-4">
        <h2 id="personal-loan-amortization-heading" className="text-lg font-semibold text-gray-900">
      ...
      <div className="overflow-x-auto rounded-xl border border-gray-200">
        <table className="min-w-full text-sm" aria-label="Personal loan amortization schedule">
          <thead>
