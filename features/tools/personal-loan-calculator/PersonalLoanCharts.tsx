...
import { formatINR } from "@/lib/personalLoan";
...
export function PersonalLoanCharts({ loanAmount, totalInterest, schedule }: Props) {
  const donutData = [
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-4">
          ...
          <ResponsiveContainer width="100%" height={200}>
            <AreaChart data={balanceData} margin={{ top: 4, right: 4, left: 0, bottom: 0 }}>
              <defs>
                <linearGradient id="plBalance" x1="0" y1="0" x2="0" y2="1">
